...
from experiments.sim.mujoco_env.y_env import SimpleEnv  # 自定义的 MuJoCo 环境封装类
...
TASK_NAME = "Pick up the cola bottle and put it in the container."
xml_path = "experiments/sim/assets/arenas/scanned_objects/example_scene_y.xml"
